...
(function (ShadowExample) {
    ...
    function renderShadowmap() {
        ...
        if (shadowCoords != null)
            shadowRender.drawWithStartEnd(gl.TRIANGLE_FAN, shadowCoords.length / 2);
    }
    function update() {
