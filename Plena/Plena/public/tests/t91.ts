module t10 {
    ...
    var calibri = Assets.getFont(Font.CALIBRI, 120).fill(new Color(0, 0, 0)).stroke(new Color(0, 255, 0));
    var lobster = Assets.getFont("lobster", 120).fill(new Color(0, 0, 0));
    ...
    export function setup() {
        ...
        mouseText = TextGrix.text("The Mouse is here!", lobster.align("center").fill(new Color(255, 0, 0)), Assets.LETTERS);
        cloudCount = new TextGrix(Assets.mkFontMap(lobster, Assets.LETTERS, FontMap.BASIC_KEYS, 2));
        cloudPos = new TextGrix(Assets.mkFontMap(calibri.fill(new Color(0, 0, 0)).stroke(new Color(0, 0, 0)).size(48)));
    ...
    export function render(delta: number) {
        ...
        cloudCount.text(`Current amount of clouds: ${clouds.length + 1} (mutable text btw)`, 800)
    }
...
Plena.init(t10.setup, t10.render, t10.update, new Color(135, 206, 250));